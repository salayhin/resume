...
\urlstyle{same}\url{https://www.linkedin.com/in/salayhin/} \\ % Your website, LinkedIn profile or other web address
...
\sectionspace % Some whitespace after the section
\runsubsection{Security Pipeline}
\descript{| Big Data Consultant}
\location{Sep 2019 – Now | Mohakhali DOHS, Dhaka}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightitemize}
